function ex=initializeConnection(ex,varargin)
% function ex=initializeConnection(ex,varargin)
% 
% +eylink.initializeConnection(ex,varargin)
%
% was previously function ex=initEyelink(ex)
%
...
% 02/13/26  hn: moved to +eylink package
