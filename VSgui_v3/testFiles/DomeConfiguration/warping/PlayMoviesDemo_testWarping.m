...
try
    ...
    %     '/home/lab/Desktop/VisStim/NIHRigC/VSgui_v1_dev/testFiles/DomeConfiguration/warping/calibparameterized.mat');

    % % check warping
     PsychImaging('AddTask','AllViews','GeometryCorrection',...
         '/home/lab/Desktop/VisStim/NIHRigC/VSgui_v1_dev/testFiles/DomeConfiguration/warping/calibtestfilex_v2.mat');
    ...
    if isempty(strfind(moviename, 'http')) %#ok<STREMP>
        ...
        if isempty(moviefiles)
            ...
            %moviefiles(1).name = '/home/lab/Desktop/harish/naturalisticImages/rollercoaster_nocopyright.mp4';
        else
