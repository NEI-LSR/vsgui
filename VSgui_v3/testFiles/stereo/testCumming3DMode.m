...
% testCumming3DMode(stereoMode)
% based on StereoDemo(stereoMode)
% 
% default stereoMode is 8
%
...
try
    ...
    % using Datapixx with Cumming3D mode
    ...
    % Enable DATAPixx Cumming3D mode
    Datapixx('Open');
    ...
    [windowPtr, windowRect]=Screen('OpenWindow', scrnNum, gray_idx, [], [], [], stereoMode);
    ...
    % Done. Reset Datapixx to normal and Close the onscreen window:
