...
% Last Modified by GUIDE v2.5 13-Mar-2026 10:55:55
...
% --- Executes on button press in plotPopulation.
function plotPopulation_Callback(hObject, eventdata, handles)

% hObject    handle to plotPopulation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
set(handles.statusMessage,'String','...busy plotting files...');
pause(0.1)
handles = plotFiles(handles,'populationResponse',true);
pause(0.2)
set(handles.statusMessage,'String','');
guidata(hObject, handles);
...
set(handles.statusMessage,'String','...busy plotting files...');
pause(0.1)
handles = plotFiles(handles,'raster',true);
pause(0.2)
set(handles.statusMessage,'String','');
guidata(hObject, handles);
